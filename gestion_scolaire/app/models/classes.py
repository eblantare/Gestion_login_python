...
class Classe(BaseModel): 
    ...
    # Référence vers l'enseignant titulaire
    titulaire_id = db.Column(
        UUID(as_uuid=True), 
        db.ForeignKey('geslog_schema.enseignants.id'),
        nullable=True
    )
    ...
    # ecole = db.relationship('Ecole', backref='classes', lazy=True)
